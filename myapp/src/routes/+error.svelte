...
<head>
    ...
    <title>คุณมาผิดทาง | You're Lost</title>
...
<body>
    <div class="error-container">
        ...
        <div class="content-wrapper">
            <h1>คุณไม่ควรมาอยู่ที่ path นี้หนิ</h1>
            
            <div class="video-container">
                <iframe
                    src="https://www.youtube.com/embed/ONzntmMFXGE?autoplay=1"
            ...
            <div class="buttons">
                <a href="/main" class="btn btn-home">
                    <i class="fas fa-home"></i> กลับหน้าหลัก
                </a>
            </div>
            
            <div class="elevator-info">
                <p>ถ้าคุณหลงทาง สามารถใช้ลิฟต์ Mitsubishi GPS-III ที่ชั้น 1 เพื่อกลับสู่ล็อบบี้ได้</p>
            </div>
        </div>
    </div>
